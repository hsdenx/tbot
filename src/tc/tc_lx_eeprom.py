...
read_end_state_retry_save=tb.read_end_state_retry
tb.read_end_state_retry=20
tmp="dd if=" + randfile + " of=" + tb.tc_lx_eeprom_file + " bs=" + tb.tc_lx_eeprom_wp_obs + " count=" + tb.tc_lx_eeprom_wp_wc
tb.eof_write_con_lx_cmd(tmp)
tb.read_end_state_retry=read_end_state_retry_save
...
tb.eof_search_str_in_readline_con("FAILED")

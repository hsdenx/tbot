...
tb.config.tc_lab_cp_file_a = "/tftpboot/" + tb.config.tftpboardname + "/" + tb.config.ub_load_board_env_subdir + '/MLO'
tb.config.tc_lab_cp_file_b = rootfspath + rootfsworkdir + '/MLO'
tb.eof_call_tc("tc_lab_cp_file.py")

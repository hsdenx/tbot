...
tb.tc_lx_dummy_file_tempfile = tb.config.lab_tmp_dir + "gnlmpf_partition"
tb.eof_call_tc("tc_lx_create_dummy_file.py")

# copy dummy file into partition
tmp = "cp " + tb.tc_lx_dummy_file_tempfile + " " + tb.config.tc_lx_mount_dir
...
tmp = "cmp " + tb.tc_lx_dummy_file_tempfile + " " + tb.config.tc_lx_mount_dir + "/gnlmpf_partition"
tb.write_lx_cmd_check(tb.workfd, tmp)
tb.end_tc(True)

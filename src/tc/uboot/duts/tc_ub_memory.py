...
tb.eof_write_cmd(tb.c_con, "crc " + tmp + " 0x3fc" + " " + tb.tc_ub_memory_ram_ws_base)
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 4")
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x40")

# crc check
tb.eof_write_cmd(tb.c_con, "mw " + tb.tc_ub_memory_ram_ws_base + " 0xc0cac01a 0x100")
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x100")
...
tb.eof_write_cmd(tb.c_con, "mw " + tb.tc_ub_memory_ram_ws_base + " 0x00c0ffee 0x100")
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x100")
if tb.tc_ub_memory_ram_big == 'yes': 
...
# compare
ret = tb.write_cmd_check(tb.c_con, "cmp " + tb.tc_ub_memory_ram_ws_base + " "
                         + tb.tc_ub_memory_ram_ws_base_alt + " 40000", "!=")
if ret == True:
    tb.end_tc(False)
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0xc")
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base_alt + " 0xc")
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x40")

ret = tb.write_cmd_check(tb.c_con, "cmp.l " + tb.tc_ub_memory_ram_ws_base +
          " " + tb.tc_ub_memory_ram_ws_base_alt + " 40000", "!=")
if ret == True:
    tb.end_tc(False)
ret = tb.write_cmd_check(tb.c_con, "cmp.w " + tb.tc_ub_memory_ram_ws_base +
          " " + tb.tc_ub_memory_ram_ws_base_alt + " 80000", "!=")
if ret == True:
    tb.end_tc(False)
ret = tb.write_cmd_check(tb.c_con, "cmp.b " + tb.tc_ub_memory_ram_ws_base +
          " " + tb.tc_ub_memory_ram_ws_base_alt + " 100000", "!=")
if ret == True:
    tb.end_tc(False)

# cp
tb.eof_write_cmd(tb.c_con, "help cp")
tb.eof_write_cmd(tb.c_con, "cp " + tb.tc_ub_memory_ram_ws_base + " " + tb.tc_ub_memory_ram_ws_base_alt + " 10000")

tb.eof_write_cmd(tb.c_con, "cp.l " + tb.tc_ub_memory_ram_ws_base + " " + tb.tc_ub_memory_ram_ws_base_alt + " 10000")
tb.eof_write_cmd(tb.c_con, "cp.w " + tb.tc_ub_memory_ram_ws_base + " " + tb.tc_ub_memory_ram_ws_base_alt + " 20000")
tb.eof_write_cmd(tb.c_con, "cp.b " + tb.tc_ub_memory_ram_ws_base + " " + tb.tc_ub_memory_ram_ws_base_alt + " 40000")

# md
tb.eof_write_cmd(tb.c_con, "help md")
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base)

tb.eof_write_cmd(tb.c_con, "md.w " + tb.tc_ub_memory_ram_ws_base)
tb.eof_write_cmd(tb.c_con, "md.b " + tb.tc_ub_memory_ram_ws_base)

tb.eof_write_cmd(tb.c_con, "md.b " + tb.tc_ub_memory_ram_ws_base + " 0x20")
tb.eof_write_cmd(tb.c_con, "md.w " + tb.tc_ub_memory_ram_ws_base)
tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base)
...
if ret == False:
    ...
    tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x10")
    tb.eof_write_cmd(tb.c_con, "mw " + tb.tc_ub_memory_ram_ws_base + " 0 6")
    tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x10")
    tb.eof_write_cmd(tb.c_con, "md " + tb.tc_ub_memory_ram_ws_base + " 0x40")
